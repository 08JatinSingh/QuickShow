...
const AddShows = () => {
    ...
    const fetchNowPlayingMovies = async () => {
        try {
            ...
            toast.error('Unable to load movies. Please try again.')
            setNowPlayingMovies([])
        } finally {
            setIsLoading(false)
        }
    ...
    // Only show Loading while API request is actually running
    if (isLoading) {
        return <Loading />
    }
            ...
            {nowPlayingMovies.length === 0 ? (
                ...
                <div className="mt-10 text-center">
                    ...
                    <button
                        ...
                        className="bg-primary text-white px-5 py-2 mt-4 rounded hover:bg-primary/90"
                    >
                        Retry
                    </button>
                </div>
